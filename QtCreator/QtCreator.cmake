...
set_property(TARGET qmljs PROPERTY IMPORTED_LOCATION_DEBUG "${BINARY_DIR}/Debug/qmljs${CMAKE_STATIC_LIBRARY_SUFFIX}")
set_property(TARGET qmljs PROPERTY IMPORTED_LOCATION_RELEASE "${BINARY_DIR}/Release/qmljs${CMAKE_STATIC_LIBRARY_SUFFIX}")

set_property(TARGET qmljs PROPERTY INTERFACE_LINK_LIBRARIES
	"${BINARY_DIR}/$<CONFIG>/cplusplus${CMAKE_STATIC_LIBRARY_SUFFIX}"
	"${BINARY_DIR}/$<CONFIG>/utils${CMAKE_STATIC_LIBRARY_SUFFIX}"
	"${BINARY_DIR}/$<CONFIG>/languageutils${CMAKE_STATIC_LIBRARY_SUFFIX}")
